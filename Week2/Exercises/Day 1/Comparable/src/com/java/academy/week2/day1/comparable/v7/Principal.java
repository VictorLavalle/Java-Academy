package com.java.academy.week2.day1.comparable.v7;
...
public class Principal {
    public static void main(String[] args) {
        ...
        students.sort((e1, e2) -> e2.getName().compareTo(e1.getName()));
        ...
        students.sort((e1, e2) -> Double.compare(e2.getAverage(), e1.getAverage()));
        ...
        students.sort((e1, e2) -> Integer.compare(e2.getAge(), e1.getAge()));
